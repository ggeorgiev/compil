...
namespace boost
{
    ...
    template<typename F1,typename F2>
    typename boost::enable_if<is_future_type<F1>,size_t>::type wait_for_any(F1& f1,F2& f2)
    {
        detail::future_waiter waiter;
        waiter.add(f1);
        waiter.add(f2);
    ...
    template<typename F1,typename F2,typename F3>
    size_t wait_for_any(F1& f1,F2& f2,F3& f3)
    {
        detail::future_waiter waiter;
        waiter.add(f1);
        waiter.add(f2);
    ...
    template<typename F1,typename F2,typename F3,typename F4>
    size_t wait_for_any(F1& f1,F2& f2,F3& f3,F4& f4)
    {
        detail::future_waiter waiter;
        waiter.add(f1);
        waiter.add(f2);
    ...
    template<typename F1,typename F2,typename F3,typename F4,typename F5>
    size_t wait_for_any(F1& f1,F2& f2,F3& f3,F4& f4,F5& f5)
    {
        detail::future_waiter waiter;
        waiter.add(f1);
        waiter.add(f2);
