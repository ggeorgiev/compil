...
int main(int argc, const char **argv)
{
    ...
    {
        compil::SourceIdSPtr pSourceId(
            compil::SourceId::Builder()
                .set_value(input_file_path.string())
                .set_uniquePresentation(pFileSourceProvider->getUniquePresentationString(input_file_path.string()))
                .finalize());
